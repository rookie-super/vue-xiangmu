        ...
        <div class="sku-box store-content">
            <div class="sort-option">
                <ul class="line clear">
                    ...
                    <li><a href="javascript:;" class="">热门</a></li>
                    <li><a href="javascript:;" class="">价格 ∧</a></li>
                    <li><a href="javascript:;" class="">价格 ∨</a></li>
                </ul>
            </div>
            <div class="gray-box">
                <div class="item-box" >
                    <div class="item" v-for="item in items">
                        <div>
                            <div class="item-img">
                                <img alt="White Modern Chair" :src="item.img" style="opacity: 1;">
                            </div>
                            <h6>原价： ￥{{item.moneyBefore}}</h6>
                            <h3 >{{item.name}}</h3>
                            <div class="item-btns clearfix">
                                <span class="item-gray-btn"><router-link :to="'/Goods/'+idEs+'/'+item.id">详情页面</router-link></span>
                                <span class="item-blue-btn" @click="addCartPanel(item)">加入购物车 </span>
                            </div>
                            <div class="item-price clearfix">
                                <i>￥</i><span>{{item.moneyNow}}</span>
                            </div>
                            <div class="discount-icon">false</div>
                            <div class="item-cover">
                                <router-link :to="'/Goods/'+idEs+'/'+item.id"></router-link>
                            </div>
                        </div>
                    </div>
                </div>
