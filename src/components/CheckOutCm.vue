        ...
        <div class="content page-order-checkout checkout">
                    ...
                    <div class="box-inner js-checkout-address-panel ">
                        <div class="address-common-table js-multiple-address-panel">
                            <ul class="address-item-list clear js-address-item-list">
                                <li class="js-choose-address " v-for="it in its" @click="addressFn(it.id)" :class="{'selected-address-item':addressId==it.id}" >
                                    <div class="address-item">
                                        <div class="name-section"> {{it.name}} </div>
                                        <div class="mobile-section">{{it.phone}}</div>
                                ...
                                <li @click="newPlay='block',shuJu={}" class="add-address-item js-add-address">
                                    <p>添加地址</p>
                                </li>
                            </ul>
                        </div>
                        ...
                        <!-- add address -->
                        <div id="pop" :style="'display:' +newPlay">
                                ...
                                <div class="dialog-panel">
                                    <div class="topbar">
                                        <div class="dialog-tit clear">
                                            <h4 class="js-dialog-title">新的地址</h4>
                                        </div><span class="dialog-close" @click="newPlay='none'">x</span>
                                    </div>
                                                ...
                                                <div class="save-address-box">
                                                    <div class="address-form">
                                                        <div class="module-form-row">
                                                            <div class="form-item-v3"><i v-show="!shuJu.name"> 姓名</i><input
                                                                    type="text" class="js-verify" v-model="shuJu.name">
                                                                <div class="verify-error"></div>
                                                            </div>
                                                        </div>
                                                        <div class="module-form-row">
                                                            <div class="form-item-v3"><i v-show="!shuJu.phone">电话</i><input
                                                                    type="text" class="js-verify" v-model="shuJu.phone">
                                                                <div class="verify-error"></div>
                                                            </div>
                                                        </div>

                                                        <div class="module-form-row">
                                                            <div class="form-item-v3"><i v-show="!shuJu.city">所在省市</i><input type="text"
                                                                                           class="js-verify" v-model="shuJu.city">
                                                                <div class="verify-error"></div>
                                                            </div>
                                                        </div>
                                                        <div class="module-form-row">
                                                            <div class="form-item-v3"><i v-show="!shuJu.site">详细地址</i><input type="text"
                                                                                           class="js-verify" v-model="shuJu.site">
                                                                <div class="verify-error"></div>
                                                            </div>
                                                        </div>
                                                        <div @click="save" :class="{'disabled-btn':(!shuJu.name)||(!shuJu.phone)||(!shuJu.city)||(!shuJu.site)}" class="dialog-blue-btn big-main-btn  js-verify-address">
                                                            <a>保存</a>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <div class="gray-box">
                ...
                <div class="box-inner ui-goods-cart">
                    <div class="gray-sub-title cart-table-title"><span class="name">商品名称</span><span
                            class="subtotal">单价</span><span class="num">数量</span><span
                            class="price">小计</span></div>
                    <div class="cart-table">
                        <div class="cart-group js-cart-group">

                            <div class="cart-items" v-for="item in items">
                                <div class="items-thumb"><a href="javascript:;" target="_blank"><img
                                        :src="item.img"></a></div>
                                <div class="name hide-row">
                                    <div class="name-cell"><a href="javascript:;" title="White Modern Chair"
                                                              target="_blank">{{item.name}}</a></div>
                                </div>
                                <div class="subtotal">
                                    <div class="subtotal-cell"> ￥ {{item.money}} </div>
                                </div>
                                <div class="goods-num">{{item.num}}</div>
                                <div class="price">￥ {{item.money*item.num}}</div>
                            </div>
    ...
    export default {
        ...
        methods:{
            ...
            save(){
                ...
                this.addressId=id;
                this.newPlay="none";
                this.$store.commit("saveAddressData",this.shuJu)
            }
        }
    }
</script>
