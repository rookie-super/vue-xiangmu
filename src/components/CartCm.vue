                                ...
                                <div class="cart-top-items">
                                    <div class="cart-items">
                                        <div class="items-choose">
                                            <span class="blue-checkbox-new" @click="checkFn(item)"
                                        ...
                                        <div class="item-cols-num">
                                            <div class="select js-select-quantity">
                                                <span class="down" @click="decreaseCartCount(item.id)"
                                                      :class="{'down-disabled':item.count<=1}">-</span>
                                                <span class="num">{{item.num}}</span>
                                                <span class="up" @click="increaseCartCount(item.id)"
                                                      :class="{'up-disabled':item.count>=item.limit_num}">+</span>
                                            </div>
                                        </div>
