    ...
    <div id="header">
        <div class="nav-global">
            <div class="container">
                ...
                <ul class="nav-aside">
                    <span class="dengLu"  v-show="!(ZhuCeData.bool)"><router-link to="/denglu">登录/注册</router-link></span>
                    <li class="nav-user" v-show="ZhuCeData.bool">
                        ...
                        <div class="nav-user-wrapper">
                            <div class="nav-user-list">
                                <dl class="nav-user-avatar">
                                    ...
                                    <dt class="ng-binding" v-cloak>{{yongHuMing}}</dt>
                                </dl>
                                <ul>
                                    <router-link to="/order"><li class="address"><a href="javascript:;">我的订单</a></li></router-link>
                                    <li class="logout" @click="tuiChu"><a href="javascript:;">退出</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
...
<script>
    ...
    export default {
        ...
        computed:{
            ...
            yongHuMing(){
                if(this.ZhuCeData==={}){
                    this.ZhuCeData={name:"未登录"}
                }
                return this.ZhuCeData.name
            }
        },
        data:function(){
          return{
        ...
        methods:{
            tuiChu(){
                let data={};
                this.$store.commit("getTuiChu",data)
            }
        }
    }
</script>
...
<style>
    ...
    .nav-global {
        height: 100px;
        background-image: url(../assets/img/headerBeiJIng.jpg);
    }
